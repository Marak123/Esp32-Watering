...
function onMessage(event) {
    ...
    if (data.what == "power-now") {
        ...
        let action = data.action == "false" ? 0 : 1;
        let idPlace;
...
function getMobileToken(comm=true) {
    let JsonRet = $.ajax({
        ...
        error: function(){
            if(comm)
                messageSee("Błącz łączenia z serwerem", "error")
        }
    });
...
function generateNewMobileToken() {
    ...
    if(ret.responseText.length == 0) return "Generowanie tokenu nie piowiodło się.";
...
$(function () {
            ...
            <div class="access-sett">
                ...
                <div class="mobile-token ">
                    ...
                    <div class="day-number">
                        <p>Ilość dni: </p>
                        <input type="number" placeholder="Ilosc dni ważności" value="365" name="mobile_exp_day">
                    </div>
                    <div class="submit-button col-4">
                        <button class="button-sbm" id="delaySubmit">Zatwierdź</button>
                    </div>
    ...
    $("body").delegate(".setting-window .content .password-user .button-sbm", "click", function () {
        ...
        else alert("Hasła się nie zgadzają. Wprowadź te same hasła.");
    });
...
function generateTemp(){
    ...
    for (var elm of temperatureEle) {
        htmlMenu += `<div class="pinsMenu ${!temperatureEle.indexOf(elm) ? "select" : ""}" id="pin_${allPins[tmpEm[elm[0]][0]-1][0]}" style="width: ${100 / temperatureEle.length}%; ${!temperatureEle.indexOf(elm) ? "border-top-left-radius: 20px;" : ""}${temperatureEle.indexOf(elm) == temperatureEle.length - 1 ? "border-top-right-radius: 20px;" : ""} ">${whatName ?allPins[tmpEm[elm[0]][0]-1][0] : allPins[tmpEm[elm[0]][0]-1][1]}</div>`;
        ...
        htmlElem += ` <div id="pin_${allPins[tmpEm[elm[0]][0]-1][0]}" style="display: ${!temperatureEle.indexOf(elm) ? "flex" : "none"}">
                    <h3>${allPins[tmpEm[elm[0]][0]-1][1]}</h3>
                    <div class="term-bar">
                        <div class="den">
                            <div class="dene">
                                <div class="denem">
                    ...
                    <div class="icon-sts">
                        <div class="fan ${airOn}" id="pin_${allPins[tmpEm[elm[0]][0]-1][0]}">
                        ...
                        <div class="heat ${heatOn}" id="pin_${allPins[tmpEm[elm[0]][0]-1][0]}">
                    ...
                    <div class="setTemperature" pin="${allPins[tmpEm[elm[0]][0]-1][0]}" indexele="${temperatureEle.indexOf(elm)}">
    ...
    $("bar").delegate('#show-update-detail', 'click', function(){
        ...
        $('body').prepend(`<div id="bg-oppacity"></div>
            <popup id="update-info" class="show">
                ...
                <h3>
                    Została wypuszczona nowa aktualizacja oprogramowania
                </h3>
                <ul id="data-update">
            ...
            if(dataUpdate.status == 'success'){
                if(dataUpdate.update){
                    ...
                    $('body').prepend(`<popup id="update-bar">
                            ...
                            <button type="button" id="show-update-detail" title="Pokaż szczegóły aktualizacji">Zobacz Szczegóły</button>
                        </popup>`);
                }
            }
        }
