...
var makeItRain = function makeItRain() {
  $(".rain").empty();
  var counterRain = 100;
...
var MainMenu = function () {
  var MainMenu = function MainMenu(config) {
    config = config || {};
...
!function (e) {
  ...
  var i = function (_i2) {
    ...
    var u,
      ...
      return '<td colspan="3"><span class="bdpw-clock-digit center' + ("h" == e ? " cursor" : "") + '" title="Pick Hour" data-action="showHours" data-time-component="hours">10</span><span class="bdpw-timepicker-colon">:</span><span class="bdpw-clock-digit center' + ("m" == e ? " cursor" : "") + '" title="Pick Minute" data-action="showMinutes" data-time-component="minutes">30</span><span class="bdpw-timepicker-colon">:</span><span class="bdpw-clock-digit center' + ("s" == e ? " cursor" : "") + '" title="Pick Second" data-action="showSeconds" data-time-component="seconds">20</span><span class="bdpw-clock-digit center" title="Pick Second" data-action="togglePeriod" data-time-component="period">AM</span></td>';
        ...
        M = '<td><a href="" tabindex="-1" title="' + c.tooltips.incrementHour + '" data-action="' + c.tooltips.incrementHour + '"><span class="bdpw-timepicker-btn ' + c.icons.up + '"></span></a></td>',
        S = '<td><a href="" tabindex="-1" title="' + c.tooltips.decrementHour + '" data-action="' + c.tooltips.decrementHour + '"><span class="bdpw-timepicker-btn ' + c.icons.down + '"></span></a></td>',
        P = '<td><a href="" tabindex="-1" title="' + c.tooltips.incrementMinute + '" data-action="' + c.tooltips.incrementMinute + '"><span class="bdpw-timepicker-btn ' + c.icons.up + '"></span></a></td>',
        O = '<td><a href="" tabindex="-1" title="' + c.tooltips.decrementMinute + '" data-action="' + c.tooltips.decrementMinute + '"><span class="bdpw-timepicker-btn ' + c.icons.down + '"></span></a></td>',
        E = '<td><a href="" tabindex="-1" title="' + c.tooltips.incrementSecond + '" data-action="' + c.tooltips.incrementSecond + '"><span class="bdpw-timepicker-btn ' + c.icons.up + '"></span></a></td>',
        H = '<td><a href="" tabindex="-1" title="' + c.tooltips.decrementSecond + '" data-action="' + c.tooltips.decrementSecond + '"><span class="bdpw-timepicker-btn ' + c.icons.down + '"></span></a></td>',
        I = function I(e, t) {
      if (h) {
        var n = e.hour(),
            a = 12 == n ? 12 : n + 12;
      ...
      var e,
          ...
          n,
          a,
          r = de("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"),
      ...
      if (L()) {
        for (r.eq(0).find("span").attr("title", c.tooltips.prevMonth), r.eq(1).attr("title", c.tooltips.selectMonth), r.eq(2).find("span").attr("title", c.tooltips.nextMonth), a.find(".disabled").removeClass("disabled"), r.eq(1).text(f.format(c.dayViewHeaderFormat)), R(f.clone().subtract(1, "M"), "M") || r.eq(0).addClass("disabled"), R(f.clone().add(1, "M"), "M") || r.eq(2).addClass("disabled"), e = f.clone().startOf("M").startOf("w").startOf("d"), n = 0; n < 42; n++) {
          0 === e.weekday() && (t = de("<tr>"), c.calendarWeeks && t.append('<td class="cw">' + e.week() + "</td>"), i.push(t)), o = ["day"], e.isBefore(f, "M") && o.push("old"), e.isAfter(f, "M") && o.push("new"), e.isSame(u, "d") && !p && o.push("active"), R(e, "d") || o.push("disabled"), e.isSame(j(), "d") && o.push("today"), 0 !== e.day() && 6 !== e.day() || o.push("weekend"), N({
            type: "dp.classify",
            date: e,
            classNames: o
        ...
        a.find("tbody").empty().append(i), s = y.find(".datepicker-months"), d = s.find("th"), l = s.find("tbody").find("span"), d.eq(0).find("span").attr("title", c.tooltips.prevYear), d.eq(1).attr("title", c.tooltips.selectYear), d.eq(2).find("span").attr("title", c.tooltips.nextYear), s.find(".disabled").removeClass("disabled"), R(f.clone().subtract(1, "y"), "y") || d.eq(0).addClass("disabled"), d.eq(1).text(f.year()), R(f.clone().add(1, "y"), "y") || d.eq(2).addClass("disabled"), l.removeClass("active"), u.isSame(f, "y") && !p && l.eq(u.month()).addClass("active"), l.each(function (e) {
          ...
          for (n.eq(0).find("span").attr("title", c.tooltips.prevCentury), n.eq(2).find("span").attr("title", c.tooltips.nextCentury), t.find(".disabled").removeClass("disabled"), (a.isSame(le({
            ...
            e = a.year() + 12, o = c.minDate && c.minDate.isAfter(a, "y") && c.minDate.year() <= e, s = c.maxDate && c.maxDate.isAfter(a, "y") && c.maxDate.year() <= e, d += '<span data-action="selectDecade" class="decade' + (u.isAfter(a) && u.year() <= e ? " active" : "") + (R(a, "y") || o || s ? "" : " disabled") + '" data-selection="' + (a.year() + 6) + '">' + (a.year() + 1) + " - " + (a.year() + 12) + "</span>", a.add(12, "y");
          }
      ...
      if (e = e.clone().locale(c.locale), B() && e.tz(c.timeZone), 1 !== c.stepping) for (e.minutes(Math.round(e.minutes() / c.stepping) * c.stepping).seconds(0); c.minDate && e.isBefore(c.minDate);) {
      ...
      return n.prop("disabled") || !c.ignoreReadonly && n.prop("readonly") || y || (void 0 !== n.val() && 0 !== n.val().trim().length ? G(X(n.val().trim())) : p && c.useCurrent && (c.inline || n.is("input") && 0 === n.val().trim().length) && (e = j(), "string" == typeof c.useCurrent && (e = {
        ...
        for (!0 === c.calendarWeeks && e.append(de("<th>").addClass("cw").text("#")); t.isBefore(f.clone().endOf("w"));) {
          e.append(de("<th>").addClass("dow").text(t.format("dd"))), t.add(1, "d");
        }

        y.find(".datepicker-days thead").append(e);
      }(), function () {
        for (var e = [], t = f.clone().startOf("y").startOf("d"); t.isSame(f, "y");) {
          e.push(de("<span>").attr("data-action", "selectMonth").addClass("month").text(t.format("MMM"))), t.add(1, "M");
        }
      ...
      for (t in x[d] = "p", x) {
        x.hasOwnProperty(t) && "p" === x[t] && (o.push(t), parseInt(t, 10) !== d && (s[t] = !0));
      }
  ...
  return de.fn.datetimepicker = function (n) {
    ...
    var t,
        ...
        r = !0;
    if ("object" == _typeof(n)) return this.each(function () {
      var e,
          t = de(this);
    ...
    tooltips: {
      ...
      togglePeriod: "Przełącz okres dnia",
...
function animateButton(e) {
  ...
  if (whichButton == "planSubmit") {
    var plan = getValuePlan();

    if (plan != "failedRead") {
      if (plan.pow == "week") planWeekSend(plan.action, plan.pins, plan.week, plan.hours);else if (plan.pow == "date") planDataSend(plan.action, plan.pins, plan.data, plan.hours);
    }
  }
}
...
(function (e) {
  ...
  e.fn.weekLine.defaultSettings = {
    dayLabels: ["Pon", "Wt", "Śr", "Czw", "Pt", "Sob", "Niedz"],
    mousedownSel: true,
    startDate: null,
    onChange: null
  };
  var n = {
    ...
    getSelected: function getSelected(n, i) {
    ...
    setSelected: function setSelected(n) {
      var r = e(this),
          s = r.children(),
          o = n.split(",");
      s.removeClass(t);
...
function genListElem() {
  ...
  try {
    for (var _iterator = listActionElm[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      var el = _step.value;
      htmlListAction += " <div class=\"pin_".concat(allPins[el[3]][0], "_ac listElm\" index=\"").concat(listActionElm.indexOf(el), "\">\n                                        <div class=\"dt\" data=\"").concat(el[0][0] + "/" + el[0][1] + "/" + el[0][2], "\"><p>").concat(el[0][0] >= 0 && el[0][0] <= 9 ? "0" + el[0][0] : el[0][0], ".").concat(el[0][1] >= 0 && el[0][1] <= 9 ? "0" + el[0][1] : el[0][1], ".").concat(el[0][2], "</p></div>\n                                        <div class=\"hr\" hours=\"").concat(el[1][0] + ":" + el[1][1], "\"><p>").concat(el[1][0] >= 0 && el[1][0] <= 9 ? "0" + el[1][0] : el[1][0], ":").concat(el[1][1] >= 0 && el[1][1] <= 9 ? "0" + el[1][1] : el[1][1], "</p></div>\n                                        <div class=\"ac\" action=\"").concat(el[2], "\"><p>").concat(el[2] ? "Włączenie" : "Wyłączenie", "</p></div>\n                                        <div class=\"nm\" pin=\"").concat(allPins[el[3]][0], "\" indexPins=\"").concat(el[3], "\"><p>").concat(allPins[el[3]][1], "(").concat(allPins[el[3]][0], ")</p></div>\n                                    </div>");
    }
  } catch (err) {
...
var gateway = "ws://".concat(window.location.hostname, "/ws");
var websocket;
$(function () {
  onLoad();
});
...
function initWebSocket() {
  ...
  websocket.onclose = function () {
    console.log("Połączenie z ESP zostało zamknięte ale nastąpi próba ponownego otwarcia połączenia.");
...
function onMessage(event) {
  ...
  if (data.what == "power-now") {
    ...
    var action = data.action == "false" ? 0 : 1;
    var idPlace;

    for (var _i3 = 0; _i3 < allPins.length; _i3++) {
      if (allPins[_i3][0] == parseInt(data.pinID)) {
        idPlace = _i3 + 1;
        break;
      }
    }
    ...
    try {
      for (var _iterator2 = elementsPins[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
...
function getMobileToken(callback) {
  var objJSON = {
  ...
  $.ajax({
    url: "getMobileToken",
    method: "POST",
    data: objJSON // success: function(data){
    //     messageSee("Pomyślnie wykonano żądanie", "success")
    //     // JsonRet = JSON.parse(data);
    //     console.log("WORK: ")
    //     console.log(data);
    //     callback(data);
    // },
...
callback(data);
console.log(getMobileToken(function (data) {
  console.log(data);
}));
...
function updateTemperature(date) {
  ...
  try {
    for (var _iterator3 = date[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
      var _el2 = _step3.value;
      $(".container .temperature .containerPins #pin_".concat(_el2.pinID, " .term-bar .deneme")).html("".concat(parseInt(_el2.curlTemp), "<span>").concat((_el2.curlTemp - parseInt(_el2.curlTemp)).toString().substr(1, 2), "</span><strong>\xB0</strong>"));
    }
  } catch (err) {
...
function powerNow_change(act, pinId) {
  if (act == "on" || act == true || act == "true") {
    $(".power-now .pin_" + pinId).removeClass("off").addClass("on");
    $(".power-now .pin_" + pinId + " .text-info .info-power").html("WŁĄCZONE");
  } else if (act == "off" || act == false || act == "false") {
    $(".power-now .pin_" + pinId).removeClass("on").addClass("off");
    $(".power-now .pin_" + pinId + " .text-info .info-power").html("WYŁĄCZONE");
  }
}
...
function generatePins() {
  ...
  try {
    for (var _iterator4 = allPins[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      if (ele[2] == "power") {
        ...
        for (i = 0; i < ele[1].length; i++) {
          pinName += "<p>".concat(ele[1][i], "</p>");
        }

        delayPins += "<div class=\"pin_".concat(ele[0], "\">\n                                <div class=\"selector\">\n                                    <label class=\"checkbox bounce\">\n                                        <input type=\"checkbox\" name=\"").concat(ele[2], "\" pin=\"").concat(ele[0], "\">\n                                        <svg viewBox=\"0 0 21 21\">\n                                            <polyline points=\"5 10.75 8.5 14.25 16 6\"></polyline>\n                                        </svg>\n                                    </label>\n                                </div>\n                                <div class=\"pin-name\">").concat(pinName, "</div>\n                            </div>");
      }
    }
  } catch (err) {
...
$(function () {
  var Data = new Date();
  var dataFormat = Data.getDate() + "/" + (Data.getMonth() + 1) + "/" + Data.getFullYear();
...
try {
  for (var _iterator5 = elementsPins[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
    var el = _step5.value;
...
$(function () {
  ...
  $("body").delegate(".setting-window .content .user-name .button-sbm", "click", function () {
    var username = $('.setting-window .content .user-name input[name="newUsername"]').val();
    var password = $('.setting-window .content .user-name input[name="password"]').val();
    changeUsernameSend(username, password);
  });
  $("body").delegate(".setting-window .content .password-user .button-sbm", "click", function () {
    var oldPassword = $('.setting-window .content .password-user input[name="oldPassword"]').val();
    var newPassword = $('.setting-window .content .password-user input[name="newPassword"]').val();
    var newPasswordRepeat = $('.setting-window .content .password-user input[name="repeat-newPassword"]').val();
    if (newPassword == newPasswordRepeat) changePasswordSend(newPassword, oldPassword);else alert("Hasła się nie zgadzają. Wprowadź te same hasła.");
  });
  $("body").delegate(".setting-window .content .access-sett .exp-date .button-sbm", "click", function () {
    var exp_day = $('.setting-window .content .access-sett .exp-date input[name="exp-day"]').val();
  ...
  $("body").delegate(".setting-window .mobile-token .copyToClipboard", "click", function (event) {
    ...
    try {
      ...
      if (successful) messageSee("Pomyślnie skopiowano", "success");else messageSee("Kopiowanie nie powiodło się. Spróbuj jeszcze raz.", "failed");
    } catch (err) {
  ...
  $("body").delegate(".setting-window #mobileToken .generateNew", "click", function () {
    var newToken = generateNewMobileToken() || false;

    if (!newToken) {
      messageSee("Wygenerowanie nie powiodło się. Spróbuj jeszcze raz.", "failed");
    } else {
...
$(function () {
  ...
  try {
    for (var _iterator6 = allPins[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
      var _em = _step6.value;

      if (_em[2] == "power" || _em[2] == "air" || _em[2] == "heat") {
        posi = -1;
        ...
        if (_em[2] == "power") {
          ...
          try {
            for (var _iterator7 = elementsPins[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              var lm = _step7.value;
              if (lm[0] == allPins.indexOf(_em)) posi = lm[1];
            }
          } catch (err) {
          ...
          try {
            for (var _iterator8 = tmpEm[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
              var _lm = _step8.value;

              if (_lm[1] == allPins.indexOf(_em)) {
                var _iteratorNormalCompletion9 = true;
                var _didIteratorError9 = false;
                var _iteratorError9 = undefined;

                try {
                  for (var _iterator9 = temperatureEle[Symbol.iterator](), _step9; !(_iteratorNormalCompletion9 = (_step9 = _iterator9.next()).done); _iteratorNormalCompletion9 = true) {
          ...
          try {
            for (var _iterator10 = tmpEm[Symbol.iterator](), _step10; !(_iteratorNormalCompletion10 = (_step10 = _iterator10.next()).done); _iteratorNormalCompletion10 = true) {
              var _lm2 = _step10.value;

              if (_lm2[2] == allPins.indexOf(_em)) {
                var _iteratorNormalCompletion11 = true;
                var _didIteratorError11 = false;
                var _iteratorError11 = undefined;

                try {
                  for (var _iterator11 = temperatureEle[Symbol.iterator](), _step11; !(_iteratorNormalCompletion11 = (_step11 = _iterator11.next()).done); _iteratorNormalCompletion11 = true) {
                    var _elm = _step11.value;
        ...
        htmlStatusList += "<div><div><span class=\"".concat(posi ? "on" : "off", "\"></span>\n                                                    <p>").concat(posi ? "Włączone" : "Wyłączone", "</p>\n                                                </div>\n                                                <div>\n                                                    <p>").concat(_em[1], "</p>\n                                                </div>\n                                            </div>");
      }
    }
  } catch (err) {
...
function generateTemp() {
  ...
  var tempeF = "";
  var tempeS = "";
  var whatName = 100 / temperatureEle.length < 15 ? true : false;
  var _iteratorNormalCompletion12 = true;
  var _didIteratorError12 = false;
  var _iteratorError12 = undefined;

  try {
    for (var _iterator12 = temperatureEle[Symbol.iterator](), _step12; !(_iteratorNormalCompletion12 = (_step12 = _iterator12.next()).done); _iteratorNormalCompletion12 = true) {
      var elm = _step12.value;
      htmlMenu += "<div class=\"pinsMenu ".concat(!temperatureEle.indexOf(elm) ? "select" : "", "\" id=\"pin_").concat(allPins[tmpEm[elm[0]][0] - 1][0], "\" style=\"width: ").concat(100 / temperatureEle.length, "%; ").concat(!temperatureEle.indexOf(elm) ? "border-top-left-radius: 20px;" : "").concat(temperatureEle.indexOf(elm) == temperatureEle.length - 1 ? "border-top-right-radius: 20px;" : "", " \">").concat(whatName ? allPins[tmpEm[elm[0]][0] - 1][0] : allPins[tmpEm[elm[0]][0] - 1][1], "</div>");
...
$(function () {
  ...
  $(".temperature").delegate(".setTemperature", "mouseenter", function () {
    $(this).append("<div class=\"setTemperature-tooltip tooltip-edit\" tooltip-edit pin=\"".concat($(this).attr("pin"), "\"> <i class=\"fas fa-pen\"></i></div>"));
  });
  ...
  $(".timetable .elemList").delegate(".list-elem-tooltip", "click", function () {
    var indxElm = $(this).parent().attr("index"); // listActionElm.splice(indxElm, 1);
...
function messageSee(text, action) {
  if (!$('div.messageAlert').length) {
    $('body').prepend("<div class=\"messageAlert ".concat(action, "\"><p>").concat(text, "</p></div>"));
    $('.messageAlert').css({
      'right': '-300%'
    }).animate({
      "right": "10"
